...
public class DatabaseManagerRestApi : MonoBehaviour
{
    ...
    public void setScoreWithRestApi(int assetID,int score)
    {
        ...
        {
            StartCoroutine(KeyMaker.instance.endSessionApi("https://api.cryptofightclub.io/game/sdk/chicken/end-session",assetID, score));
        }
        else
        {
    ...
    public void startSessionFromRestApi(int _assetID)
    {
        scoreUpdateTried = 0;
        // change url later
        StartCoroutine(KeyMaker.instance.startSessionApi("https://api.cryptofightclub.io/game/sdk/chicken/start-session", _assetID));
    }
